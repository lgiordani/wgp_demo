...
def test_build_http_response_from_successful_response_object(successful_response_object):
    ...
    expected_flask_response = Response(json.dumps(successful_response_object.value), mimetype='application/json',
                                       status=200)
...
def test_build_http_response_from_resource_error_response_object():
    ...
    expected_flask_response = Response(json.dumps(error_object.value), mimetype='application/json',
                                       status=404)
